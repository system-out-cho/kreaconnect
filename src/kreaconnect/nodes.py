...
class GPTImage: 
    ...
    def INPUT_TYPES(s):
        return { 
            "required": {
                ...
                "backgroundImage": (["auto", "transparent", "opaque"],)
            }, 
            "optional": {
                "image_1": ("IMAGE",), 
                "image_2": ("IMAGE",), 
    ...
    def requestModel(self, width, height, quality, backgroundImage, prompt, img_url_arr):

        styleImages = []
        for i in range(len(img_url_arr)):
            # obj = {"url": img_url_arr[i]}
            styleImages.append(img_url_arr[i])
    ...
    def run(self, width, height, quality, backgroundImage, prompt, image_1=None, image_2=None, image_3=None):
        ...
        self.requestModel(width, height, quality, backgroundImage, prompt, img_url_arr)
